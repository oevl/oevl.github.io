...
BLOG_AUTHOR = "@oevl"  # (translatable)
BLOG_TITLE = "Omar Vasquez's GitHub Pages"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://oevl.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://oevl.github.io/"
BLOG_EMAIL = "omar@vasquezlima.com"
BLOG_DESCRIPTION = "The GitHub adventures of Omar Vasquez @oevl"  # (translatable)
